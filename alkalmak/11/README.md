...
=
\sum_{\vartheta}
\Pr(D\mid \vartheta,m_i)\Pr(\vartheta\mid m_i).
$$
...
=
\int
\Pr(D\mid \vartheta,m_i)\Pr(\vartheta\mid m_i)\,d\vartheta.
$$
...
\Pr(m_i\mid D)
=
\frac{\Pr(D\mid m_i)\Pr(m_i)}{\Pr(D)}.
$$

Két modellre felírva:

$$
\frac{\Pr(m_1\mid D)}{\Pr(m_2\mid D)}
=
\frac{\Pr(D\mid m_1)}{\Pr(D\mid m_2)}
\cdot
\frac{\Pr(m_1)}{\Pr(m_2)}.
$$
...
$$
BF_{\text{Hawkins},\text{Winden}}
=
\frac{\Pr(\text{derült}\mid \text{Hawkins})}
{\Pr(\text{derült}\mid \text{Winden})}
=
\frac{0.5}{0.1}=5.
$$
...
$$
\Pr(\text{Hawkins}\mid \text{derült})
=
\frac{0.5\cdot 0.5}{0.5\cdot 0.5+0.1\cdot 0.5}
=
\frac{0.25}{0.30}
\approx 0.833.
$$
...
BF_{21}
=
\frac{\Pr(17\mid m_2)}{\Pr(17\mid m_1)}.
$$
...
BF_{21}
=
\frac{\Pr(19\mid m_2)}{\Pr(19\mid m_1)}
\approx 0.79.
$$
